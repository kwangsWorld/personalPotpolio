...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		 StringBuilder urlBuilder = new StringBuilder("http://apis.data.go.kr/B552584/ArpltnInforInqireSvc/getMinuDustFrcstDspth"); /*URL*/
	        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=ZsAm8VoBPi5w0RdM1ZQ7xKke6CsM2au6NjaK8r8++VN7ffjZG/lEkSMv4CDRd29+s7oYJ2ceFwMPS80dF0SwtA=="); /*Service Key*/
